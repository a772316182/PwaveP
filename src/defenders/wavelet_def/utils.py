from operator import attrgetter  # 在文件顶部添加
...
def smooth_risk_calculation(
    ...
    def hook(module, grad_input, grad_output):
        if model.__class__.__name__ == "PCT":
            grads_in_hook.append(grad_output[0].detach())
        else:
            grads_in_hook.append(grad_input[0].detach())
