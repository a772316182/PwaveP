...
from src.utils.graph import build_adjacency_matrix_from_batched_point_clouds
...
class WaveletTransformUtilCheb(nn.Module):
    ...
    def _build_bases(self, batched_pc: torch.Tensor):
        ...
        adjs = build_adjacency_matrix_from_batched_point_clouds(
            batched_pc, k=self.k_neighbors, return_numpy=True
        )
        ...
        for adj in adjs:
            ...
            pygsp2_g.compute_fourier_basis()
