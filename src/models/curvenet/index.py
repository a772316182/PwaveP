...
class CurveNet(nn.Module):
    def __init__(self, dataset: str, k=20, setting="default"):
    ...
    def forward(self, pc, get_flatten_curve_idxs=False, need_feature=False, **kwags):
        if pc.shape[-1] == 3:
            pc = pc.permute(0, 2, 1)

        flatten_curve_idxs = {}
        l0_points = self.lpfa(pc, pc)

        l1_xyz, l1_points, flatten_curve_idxs_11 = self.cic11(pc, l0_points)
        ...
        return {"logit": x, "flatten_curve_idxs": flatten_curve_idxs, "feature": feat}
