...
if __name__ == "__main__":
    ...
    from src.defenders.wavelet_def_slow.starter import (
        start_wavelet_gard_wrt_coff_energy,
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=20,
        help="number of neighbors for wavelet transform",
    )
    parser.add_argument(
    ...
    parser.add_argument("--filter_rate", type=float, default=0.09, help="filter rate")
    parser.add_argument(
