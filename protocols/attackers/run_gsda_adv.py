...
if __name__ == "__main__":
    ...
    from src.attackers.gsda.starter import start_gsda_adv_attack
    ...
    all_attacked_pc = start_gsda_adv_attack(
        model=model,
        device=device,
    ...
    torch.save(
        all_attacked_pc,
        pre_check_path(
            f"{project_root_path}/attacked_data/gsda/{args.dataset.lower()}_{args.model.lower()}_res.pt"
        ),
    )
