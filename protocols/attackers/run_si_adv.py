...
if __name__ == "__main__":
    ...
    from src.attackers.si_adv.starter import start_si_adv_attack
    ...
    all_attacked_pc = start_si_adv_attack(
        model=model,
        device=device,
    ...
    torch.save(
        all_attacked_pc,
        pre_check_path(
            f"{project_root_path}/attacked_data/si_adv/{args.dataset.lower()}_{args.model.lower()}_res.pt"
        ),
    )
