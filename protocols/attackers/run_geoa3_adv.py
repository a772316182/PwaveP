...
if __name__ == "__main__":
    ...
    from src.attackers.geoa3.starter import start_geoa3_attack
    ...
    all_attacked_pc = start_geoa3_attack(
        model=model,
        device=device,
    ...
    torch.save(
        all_attacked_pc,
        pre_check_path(
            f"{project_root_path}/attacked_data/geoa3/{args.dataset.lower()}_{args.model.lower()}_res.pt"
        ),
    )
